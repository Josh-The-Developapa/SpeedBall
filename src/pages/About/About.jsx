  ...
  return (
    <div className="min-h-screen bg-[#8A7345] text-white flex flex-col about-page">
      ...
      <section className="flex flex-col xl:flex-row flex-grow about-section ">
        {/* Image Section */}
        <div className="about-image-div relative xl:w-[75%] xl:h-[75vh] h-[400px]">
          <img
            src={hero}
            alt="Hero"
            className="w-full xl:h-[75vh] object-cover object-top h-[400px]"
          />
          {/* Mobile Fade */}
        ...
        >
          <img
            src={SBsig}
            alt="SB-Sig"
            className="h-[100px] w-[100px] object-contain m-0 mb-[20px]"
          />
          <p>
